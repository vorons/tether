...
- [x] T1: Rewrite `api.lua` for SSE streaming via `tether.open_pipe`/`tether.read_line`
...
- [x] T2: Add tool-call parsing to `agent.lua`
...
- [x] T3: Wire tools into `ui.lua` transcript rendering
...
- [x] T4: `make test` passes with new M3 code
